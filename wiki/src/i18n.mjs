...
export const UI = {
  ...
  askWelcome: pack(
    'Vraag hoe een scherm werkt, waar je de beste auto, boot of motor steelt, of — na inloggen hier — hoeveel geld je hebt, welke rank je bent en hoelang VIP nog loopt. Live straatprijzen blijven in het spel.',
    'Ask how a screen works, where to steal the best car, boat or motorcycle, or — after signing in here — how much money you have, which rank you are and how long VIP lasts. Live street prices stay in the game.',
    'Frag, wie ein Bildschirm funktioniert, wo du das beste Auto, Boot oder Motorrad stiehlst, oder — nach Login hier — wie viel Geld, welchen Rang und wie lange VIP noch läuft. Live-Straßenpreise bleiben im Spiel.',
    'Demande comment marche un écran, où voler la meilleure voiture, bateau ou moto, ou — après connexion ici — ton argent, ton rang et le temps VIP restant. Les prix live restent en jeu.',
    'Pregunta cómo funciona una pantalla, dónde robar el mejor coche, barco o moto, o — tras entrar aquí — tu dinero, rango y VIP restante. Los precios en vivo siguen en el juego.',
    'Chiedi come funziona una schermata, dove rubare la migliore auto, barca o moto, o — dopo l’accesso qui — soldi, grado e VIP rimasto. I prezzi live restano in gioco.',
    'Pytaj, jak działa ekran, gdzie ukraść najlepsze auto, łódź lub motocykl, albo — po logowaniu tutaj — ile masz kasy, jaką rangę i ile VIP-u zostało. Żywe ceny zostają w grze.',
    'Pergunta como funciona um ecrã, onde roubar o melhor carro, barco ou moto, ou — após entrar aqui — o teu dinheiro, patente e VIP restante. Preços ao vivo ficam no jogo.'
  ),
  ...
  rankEmptySuit: pack('Leeg pak', 'Empty Suit', 'Empty Suit', 'Empty Suit', 'Empty Suit', 'Empty Suit', 'Empty Suit', 'Empty Suit'),
  rankDeliveryBoy: pack('Bezorger', 'Delivery Boy', 'Delivery Boy', 'Delivery Boy', 'Delivery Boy', 'Delivery Boy', 'Delivery Boy', 'Delivery Boy'),
  rankPicciotto: pack('Picciotto', 'Picciotto', 'Picciotto', 'Picciotto', 'Picciotto', 'Picciotto', 'Picciotto', 'Picciotto'),
  rankShoplifter: pack('Winkeldief', 'Shoplifter', 'Shoplifter', 'Shoplifter', 'Shoplifter', 'Shoplifter', 'Shoplifter', 'Shoplifter'),
  rankPickpocket: pack('Zakkenroller', 'Pickpocket', 'Pickpocket', 'Pickpocket', 'Pickpocket', 'Pickpocket', 'Pickpocket', 'Pickpocket'),
  rankThief: pack('Dief', 'Thief', 'Thief', 'Thief', 'Thief', 'Thief', 'Thief', 'Thief'),
  rankAssociate: pack('Associate', 'Associate', 'Associate', 'Associate', 'Associate', 'Associate', 'Associate', 'Associate'),
  rankCadet: pack('Cadet', 'Cadet', 'Cadet', 'Cadet', 'Cadet', 'Cadet', 'Cadet', 'Cadet'),
  rankSoldier: pack('Soldaat', 'Soldier', 'Soldier', 'Soldier', 'Soldier', 'Soldier', 'Soldier', 'Soldier'),
  rankSwindler: pack('Oplichter', 'Swindler', 'Swindler', 'Swindler', 'Swindler', 'Swindler', 'Swindler', 'Swindler'),
  rankAssassin: pack('Huurmoordenaar', 'Assassin', 'Assassin', 'Assassin', 'Assassin', 'Assassin', 'Assassin', 'Assassin'),
  rankLocalChief: pack('Lokale baas', 'Local Chief', 'Local Chief', 'Local Chief', 'Local Chief', 'Local Chief', 'Local Chief', 'Local Chief'),
  rankChief: pack('Baas', 'Chief', 'Chief', 'Chief', 'Chief', 'Chief', 'Chief', 'Chief'),
  rankDrugLord: pack('Drugsbaron', 'Drug Lord', 'Drug Lord', 'Drug Lord', 'Drug Lord', 'Drug Lord', 'Drug Lord', 'Drug Lord'),
  rankGodfather: pack('Peetvader', 'Godfather', 'Godfather', 'Godfather', 'Godfather', 'Godfather', 'Godfather', 'Godfather'),
  rankDon: pack('Don', 'Don', 'Don', 'Don', 'Don', 'Don', 'Don', 'Don'),
  rankOverlord: pack('Overlord', 'Overlord', 'Overlord', 'Overlord', 'Overlord', 'Overlord', 'Overlord', 'Overlord'),
  rankLegend: pack('Legende', 'Legend', 'Legend', 'Legend', 'Legend', 'Legend', 'Legend', 'Legend'),
  footer: pack(
