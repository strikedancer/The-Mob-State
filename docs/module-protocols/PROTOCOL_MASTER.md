...
- **NL dashboard-zijmenu (`app_nl.arb`):** gebruik **spel-/genreterminologie** waar een letterlijke vertaling misleidt (bijv. *Support* en *Crew*, *Handelswaren* voor `tradeGoods`, *Drugs*, *Red Light Districts* voor `prostitutionRedLightDistricts`); niet “Steun”, “Bemanning”, “Zwarte markt” op de verkeerde rij, “Geneesmiddelen” of “Rosse buurten” voor die items.
