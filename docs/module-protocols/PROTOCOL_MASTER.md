...
**Don hub photos:** `client/assets/images/don/*.png` (hero, rackets, NPC sharks, officials, contracts). Deploy kopieert naar `runtime/client-images/don/` (`/images/don/`). Client: `don_screen.dart` via `WebAssetHelper` + icoon-fallback. Gouden `i` opent de geïllustreerde `donInfo*`-gids.
