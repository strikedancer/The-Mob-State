...
- Voor selfie→gangster portretten, premium credit-kosten, Leonardo, runtime image-paden, client wachtstatus/verwijder-flow en admin-moderatie van overtredende portretten: zie `player-portraits.md` (mount `runtime/client-images/player_avatars/`).
