...
- **Dashboard chrome:** topbar met gecentreerd logo op het oorspronkelijke formaat, platte zijbalk en HUD-statusrij via `client/lib/theme/dashboard_chrome.dart`. Homepanelen gebruiken dezelfde hairline/sectietitels. Geen extra AppBar in de embedded Empire-shell.
