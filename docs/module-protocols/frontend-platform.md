...
- **Midnight Races:** hero onder `client/assets/images/races/` (`/images/races/*`); startveld en uitslag gebruiken catalogusauto’s via `/images/vehicles/*`. Zelfde wrap-grid als Don.
