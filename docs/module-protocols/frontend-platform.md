...
- **Don hub:** foto’s onder `client/assets/images/don/` en runtime `/images/don/*` (deploy kopieert naar `runtime/client-images/don/`). Client laadt via `WebAssetHelper.image` met icoon-fallback; geen extra AppBar in de embedded Empire-shell.
