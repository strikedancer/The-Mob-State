...
## QA (kort)
- Footer-links privacy / terms / digital goods openen een **modal** (zelfde ARB-tekst als de routes). **Almanak** opent `https://wiki.themobstate.com/{lang}/` in een nieuw tabblad. Deep links `/privacy`, `/terms`, `/digital-goods` laden nog steeds **volledige** juridische schermen; gasttaal wisselt mee.
