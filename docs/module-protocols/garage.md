...
- Personal garage repair/refuel/tune/sell stay keyed on `vehicleInventory.id` + owner. Vehicles deposited into crew storage leave this inventory and are managed from Crew → Storage instead.
