...
- Showroom collections (`car_showroom`, `motorcycle_showroom`, `boat_harbor`) are **not** extra garage space. Displayed vehicles stay owned but are locked and do not count toward garage/marina capacity. World-cap per model still counts them. Cross-country move remains smuggling; the vehicle must be in the showroom country before it can go on display.
