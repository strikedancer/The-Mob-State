...
- Detective intel on a live hit uses bodyguard defense vs tier pierce (Quick 40 / Standard 90 / Deep 160): full report, partial (country only, counts hidden), or blocked (no country). After a kill, the killer's remaining bodyguards lower murder-case identify chance (`murderCaseSolveChance`, floor 20%).
