...
- Job timeout overlay still: `client/assets/images/cooldown_jobs.png`. Leonardo: `backend/scripts/generate_cooldown_overlay_images_leonardo.py`. Client uses `kCooldownArtCacheBust`.
