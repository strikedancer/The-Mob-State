...
- Wereldchat krijgt een systeemregel wanneer een echte speler de cel in gaat, en wanneer een andere speler diegene uitkoopt of uitbreekt (beide namen). Eigen borg en eigen ontsnapping blijven stil. NPC-arrestaties niet in de lobby. Zwartgeld-arrest na crewbank-uitkoop meldt dat de betaler is opgepakt wegens zwart geld.
...
- Verify a dirty-money miss still frees the target, and a hit jails the payer (~30–45 min) with a world-chat black-money line.
