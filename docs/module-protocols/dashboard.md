...
- Na login toont Home een eenmalige **push-popup** (`maybeShowPushEnablePrompt`) ná een eventuele premium-popup. Later slaat over; Instellingen blijft de herhaal-entrypoint.
