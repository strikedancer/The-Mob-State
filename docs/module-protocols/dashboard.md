...
- Elke spelerssectie toont een gouden `i` met de uitgebreide pagina-uitleg uit Help & Uitleg. Web: geen overlay over de contentkaart — naast de hero-titel (Misdaden/Banen/Drugs/Nachtclub/Eigendommen/Prostitutie/RLD/Munitiefabriek) of in de compacte statusbalk. Don, Midnight Races en Help & Uitleg zelf zijn uitgezonderd. Op mobiel dashboard-home staat de `i` in de AppBar.
