...
- Plaats de **Start-kaart** (alleen nieuwe spelers) en de **featured dagdoel + streak** bovenaan web én mobiel. De volledige dag-/weekdoelenlijst mag daaronder of onder het speler/economie-paneel blijven. Featured daily mag `vehicle_theft_1` niet pushen onder rank 5.
...
- Verifieer dat featured daily + claim-streak op mobiel én web bovenaan staan, en dat autodiefstal niet featured is onder rank 5.
