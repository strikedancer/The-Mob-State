...
- **Game-support donate-avatar** (uiterst linksonder, 8px van de schermrand — niet tegen de zijbalk; zelfde Clash-stijl als de event-rail rechts; niet op Berichten / Wereldchat): tik opent een modal met vrij eurobedrag en Doneren. Dat is een eenmalige betaling voor servers/ontwikkeling, geen winkelproduct.
