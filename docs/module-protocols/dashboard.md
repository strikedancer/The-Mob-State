...
- Web dashboard navigation is sidebar-first: add or change module navigation via the sidebar source (`_buildWebMenuItems` + `_WebSection` content switch) and not only via the legacy tile grid. Sidebar and hamburger menu are grouped (Acties / Wereld / Sociaal / Economie / Empire / Assets / Meer) and have a search field. **Winkel** sits as a standalone item directly under Dashboard, aligned with Dashboard (not inside Economie). VIP and Credits are tabs on that one Shop page.
- **Early-rank menu:** until rank 5, grey and lock late systems (vault, hitlist, aviation, territory, casino, crypto, stocks, smuggling, drugs, nightclub, properties, don, races, prostitution, RLD, ammo factory, tune shop). Keep crimes, jobs, vehicle heist, events, court, travel, crew, friends, support, world chat, bank, black market, premium, inventory, training, school, help, hospital, prison and achievements open. Locked taps show `menuUnlocksAtRank`.
