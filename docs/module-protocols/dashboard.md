...
- **Live event rail** (rechts, niet op Events-sectie): foto-avatar + resterende-tijd-badge; Monthly Empire altijd zichtbaar; tap opent dezelfde event-detailpopup als Events (maandevent: claimables bovenaan + prijzen-om-te-winnen, geen rang-plekken). Zie `events.md`.
