...
- De feed heet **Wereldfeed** (niet “Live events”): activiteit van alle spelers. Job-fails, crew-chat en DMs horen niet in de publieke feed; succesvolle jobs tonen de spelersnaam.
