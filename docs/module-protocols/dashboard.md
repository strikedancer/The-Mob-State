...
- **Game-support donate-avatar** (linksonder, zelfde ronde Clash-stijl als de event-rail; niet op Berichten / Wereldchat): tik opent een modal met vrij eurobedrag en Doneren. Dat is een eenmalige betaling voor servers/ontwikkeling, geen winkelproduct.
