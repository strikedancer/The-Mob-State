...
- Op **Misdaden** (web) verdwijnt de losse compacte statusbalk boven de contentkaart; dezelfde HUD zit in de crimes-header (`CrimeScreen.statusHeader`) samen met paginatitel, landelijke politie, training en gedragen wapens.
