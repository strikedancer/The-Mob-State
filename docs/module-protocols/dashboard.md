...
- Plaats **Dagdoelen/Weekdoelen** bij voorkeur onder de hoofdpanelen (stats/timers) zodat de kerninformatie eerst scanbaar blijft; op compact scherm mag dit onder de laatste hoofdkaart als extra sectie.
