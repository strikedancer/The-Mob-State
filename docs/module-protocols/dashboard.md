...
- **Live event rail** (rechts, niet op Events-sectie): foto-avatar + resterende-tijd-badge; Monthly Empire altijd zichtbaar; tap opent de volledige event-detailpopup (zelfde als Events). Zie `events.md`.
