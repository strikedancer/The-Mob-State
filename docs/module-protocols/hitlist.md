...
- ✅ On web dashboard, verify there is no extra “Moordlijst” AppBar title, the hero shows open-count + security, and each contract stays on one row: avatar, name, bounty, age, Moord, then the expand dropdown
