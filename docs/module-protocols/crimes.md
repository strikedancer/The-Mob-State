...
- The Crimes screen must show both worn slots and, per crime card, which weapon will be used. Changing worn weapons happens in Inventory. The crime **car** is also chosen there (paper-doll slot). Boats stay on the Marina card; motorcycles stay on the motorcycle garage card.
