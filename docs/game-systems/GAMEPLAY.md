...
- **Straatdoel:** één Steel-knop per type. De server kiest het model (geen spelerskeuze). Gewone/uncommon auto’s wegen zwaar (50/30); rare/epic/legendary zijn 15/4/1. Elk model heeft een **rank-eis** — rank 6 ziet geen supercars, rank 17 nog geen epic (meestal rank 22+). Dure pogingen blijven daarna nog steeds moeilijker door de prijs-succescurve en heat.
