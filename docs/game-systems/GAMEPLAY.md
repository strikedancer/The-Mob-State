...
- Staff kan in Admin → **Rechtbank** live de petitie- en beroepskansen/-kosten bijsturen (runtime), en als super-admin een **amnesty** starten die ieders zichtbare strafblad wist en een promo in wereldchat plaatst (met afbeelding); nieuwe veroordelingen daarna tellen weer normaal.
