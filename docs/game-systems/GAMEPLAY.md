...
- Op web-Misdaden zitten rang/HP/beveiliging, geld, gezocht/FBI, de paginakop (straatmisdaden), landelijke politie, trainingsbonus en gedragen wapens in **één** headerpaneel. Filter/sorteer blijft een dunne balk boven het grid. Andere dashboardsecties houden de losse statusbalk erboven.
