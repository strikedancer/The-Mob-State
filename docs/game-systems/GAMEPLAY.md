...
- Op het dashboard staan events rechts als **foto-avatars** (inclusief het maandelijkse Empire Showdown, ook als die ronde nog niet live is) met een resterende-tijd-badge. Tikken opent dezelfde detailpopup als op Evenementen (prijzen + leaderboard per event).
