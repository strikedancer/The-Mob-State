...
- Inventory toont geen magazijn-/pand-hokjes tot de speler zo’n eigendom **in het huidige land** heeft. Het materialendepot toont alleen de voorraad van dit land. Spullen in andere landen blijven daar tot je reist. Zonder lokale opslag zie je het depot plus een hint om een huis, appartement of magazijn te kopen.
