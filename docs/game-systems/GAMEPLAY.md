...
- Nightclub opent met een **Tonight**-kaart (crowd, stock, Restock, Boost crowd); daaronder staat **Drug Storage** in de hoofdflow (rugzak → club, MAX / Alles uit rugzak). Crew, DJ, security en Ops Lab zitten onder **Geavanceerd** (zonder grijs Material-vlak; formuliervelden in noir-stijl). Restock onthoudt de laatste voorraadset en menuprijzen van die club (Tonight Restock koopt dezelfde set). Omzet blijft via de tick. Clubbaas kan **Koop van spelers** aanzetten; producenten in hetzelfde land verkopen via Inventaris **Aan club** tegen groothandelsprijs. De **wekelijkse nightclub-ranking** telt alleen clubs met echte weekomzet; €0 omzet wint niet en levert geen prijs. Was er die week nergens omzet, dan is er geen winnaar. Een DJ die nog op een **andere** club vastzit met een verlopen contract wordt bij inhuren vrijgegeven; speelt die DJ elders nog echt, dan krijg je een duidelijke melding i.p.v. een fout.
