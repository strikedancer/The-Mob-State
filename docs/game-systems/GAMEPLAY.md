...
- Discord-community (invite via `DISCORD_INVITE_URL`; knop op landing, Help en Instellingen). Wie niet via Discord is ingelogd kan Discord later **koppelen in Instellingen**. Patch notes staan in `#updates`.
