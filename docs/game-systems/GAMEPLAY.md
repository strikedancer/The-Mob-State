...
- **Doneer-avatar** linksonder (zelfde ronde stijl als de event-avatars rechts): tikken opent een modal om een eenmalig eurobedrag te geven voor servers en ontwikkeling. Niet op Berichten/Wereldchat.
