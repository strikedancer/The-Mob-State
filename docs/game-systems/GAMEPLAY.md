...
- Rugzak-upgrades (Zwarte Markt): klein +5, middel +10, groot +20, militair +35, VIP tactisch +50 (VIP, rang 25), **reiskoffer +70** (rang 30, 75 vakken totaal). Eén tas tegelijk; koffer is de huidige top. Hogere treden blijven in de shop zichtbaar (Kopen op slot tot rang/VIP).
