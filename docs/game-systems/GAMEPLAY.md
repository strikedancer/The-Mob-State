...
- **Wereldchat:** onder Sociaal. Eén open lobby voor alle ingelogde spelers (ook in de cel), met stickers en een scheldwoordenfilter. Privéberichten en crew-chat blijven apart. Geen push per publiek bericht. Optioneel spiegelen naar Discord zodat je ook buiten de game kunt meepraten; Discord → game werkt pas als de chat-bot in de server staat en `#wereldchat` kan lezen.
