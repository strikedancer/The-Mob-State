...
- Empire → **Drugs** gebruikt dezelfde foto-header als Don/Midnight Races, plus drie tabs: Faciliteiten, Productie en Voorraad. Heat, materialen en groothandelszendingen staan onder de header. De foto-hero **scrollt mee** (tabs blijven bovenaan). Don hetzelfde; Midnight Races heeft de hero al in dezelfde paginalijst.
