...
- Het dashboard toont **Dagdoelen** (claimable cash + XP) bovenaan op web én mobiel: alle dagdoelen met beloning op de kaart, plus een UTC claim-streak. Na claim zie je rechtsboven cash + XP. Featured daily pusht autodiefstal niet onder rang 5.
