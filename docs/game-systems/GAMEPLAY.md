...
- Technische details, SPA-fallback en QA: `docs/module-protocols/marketing-web.md` en `frontend-platform.md`. (Backend: SPA-fallback is `app.use` + GET, geen `app.get('*')` — Express 5.)
