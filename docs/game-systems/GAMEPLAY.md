...
- **Trainingscircuit (sportschool + schietschool):** één dashboard-entry en scherm (`TrainingHubScreen`); aparte **1 uur**-cooldowns en **100-sessie**-plafonds per lijn blijven server-side (`/gym`, `/shooting-range`). Help-topic-id: **`training-hub`** (`docs/module-protocols/training-hub.md`).
