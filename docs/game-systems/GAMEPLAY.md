...
- **Deel-link (Vrienden):** elke speler heeft een persoonlijke URL (`/register?ref=`). Wie zich daarmee aanmeldt krijgt **€2.000** startgeld en staat meteen als vriend. De uitnodiger krijgt **€5.000** na de eerste geslaagde misdaad of baan van die nieuweling (max 5 uitbetalingen per UTC-dag). Delen via kopiëren, het deelmenu of Facebook; geen import van de Facebook-vriendenlijst. Zie `docs/module-protocols/referrals.md`.
