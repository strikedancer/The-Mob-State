...
- Timers in de regio-modal (jouw cooldown, wanneer je weer mag aanvallen, contest-fasen, garnizoen) lopen live af. Na **Bevoorraad project** blijft die knop uit en toont de resterende 15 minuten (of de server-cooldown) tot je weer mag bevoorraden; als de tijd op is, wordt de knop vanzelf weer actief. Hetzelfde geldt op de kaart zelf: een chip toont de volgende ontgrendeling en als de wachttijd of prep-fase voorbij is, komen de aanvalsknoppen terug zonder de pagina te herladen. Een push/inbox dat de contest actief is, opent Territorium.
...
- **HQ & Upgrades visuals**: bijgebouw-afbeeldingen volgen altijd de level-tier van het bijgebouw zelf (niet de actuele HQ-stijl), zodat visuals en levelstatus consistent blijven. De upgradehub toont compacte rijen (kleine foto + level/kosten + knop), geen enorme portretkaarten.
...
### Heist Mechanics
- **Preparation**: Leader start de heist. De Start-knop toont de resterende persoonlijke 6u-cooldown in plaats van klikbaar te blijven.
