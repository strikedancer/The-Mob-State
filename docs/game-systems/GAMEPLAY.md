...
- **Berichten / postvak:** een badge of push “nieuw bericht” hoort bij bestaande threads. Spelerchats blijven gegroepeerd. Elke The Mob State-melding (badge, uitbetaling, order) is een **eigen inbox-regel**, geen lange gedeelde systeemthread. De inbox mag niet leeg lijken terwijl die berichten er wél zijn; bij een laadfout zie je retry, niet “Nog geen berichten”. In chat verstuurt **Enter** het bericht en maakt **Shift+Enter** een nieuwe regel.
