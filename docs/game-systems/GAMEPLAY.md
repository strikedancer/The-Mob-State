...
- In **Opslag** zie je per bay wat er écht in ligt (niet alleen 3/20), met kleine catalogusplaatjes per auto, wapen, tool, munitie, drugs of handelswaar. Auto- en bootplaatjes volgen de staat (nieuw/vuil/beschadigd), hetzelfde als in de garage. Op HQ tik je een opslaggebouw aan voor dezelfde inhoud.
