...
- Op het dashboard staan actieve events rechts als avatars met een **resterende-tijd-badge**; tikken opent een popup met de eventgegevens (niet alleen Events-pagina).
