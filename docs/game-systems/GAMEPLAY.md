...
- Het dashboard toont een **Markt**-tegel met het aantal actieve P2P-listings en een **wereldfeed** (recente `GET /events`, plus live SSE). Die feed is activiteit van alle spelers (met spelersnaam), geen lijst van jouw beschikbare banen; mislukte jobs en privéberichten verschijnen daar niet.
