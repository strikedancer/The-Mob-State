...
- Op **telefoon en tablet** (niet als de site al als PWA openstaat) toont de landing en het dashboard een banner **Zet op beginscherm**. Android Chrome opent het install-venster; iPhone/iPad toont Delen → Zet op beginscherm. Daarna opnieuw via Instellingen. De beginscherm-app mag **draaien** (portret en landscape). Stond het icoon er al op vóór die wijziging, verwijder het en zet het opnieuw op het beginscherm. Zie Help → Instellingen.
