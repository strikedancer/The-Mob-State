...
- [ ] Territory desktop iconen verduidelijkt: `Kies land` toont op desktop nu een expliciete globe/expand trigger met iconen in de keuzelijst, en de Territory-entry in de web-sidebar rendert een vaste zichtbare leading icon badge
