...
- [ ] Premium/Credits external image-pad fix: premium tiles gebruiken runtime paths `images/premium_tiles/...`, loader probeert web root-candidates (`/images`, `/assets/assets/images`, `/assets/images`) met cache-bust query, en de tegelset staat in `runtime/client-images/premium_tiles/` zodat de client niet afhankelijk is van gebundelde `assets/images`
