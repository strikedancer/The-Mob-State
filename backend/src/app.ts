...
import seasonPassRouter from './routes/seasonPass';
import vehiclesRouter from './routes/vehicles';
import crimesRouter from './routes/crimes';
import jobsRouter from './routes/jobs';
import propertiesRouter from './routes/properties';
import crewsRouter from './routes/crews';
import crewWarsRouter from './routes/crewWars';
import crewDealsRouter from './routes/crewDeals';
import crewMissionsRouter from './routes/crewMissions';
import friendsRouter from './routes/friends';
import messagesRouter from './routes/messages';
import globalChatRouter from './routes/globalChat';
...
import launderRouter from './routes/launder';
import stockMarketRouter from './routes/stockMarket';
...
import donRouter from './routes/don';
...
app.use('/season-pass', seasonPassRouter);
app.use('/vehicles', vehiclesRouter);
app.use('/crimes', crimesRouter);
app.use('/jobs', jobsRouter);
app.use('/properties', propertiesRouter);
app.use('/crews', crewsRouter);
app.use('/crew-wars', crewWarsRouter);
app.use('/crew-deals', crewDealsRouter);
app.use('/crew-missions', crewMissionsRouter);
app.use('/friends', friendsRouter);
app.use('/messages', messagesRouter);
app.use('/global-chat', globalChatRouter);
...
app.use('/launder', launderRouter);
app.use('/stock', stockMarketRouter);
