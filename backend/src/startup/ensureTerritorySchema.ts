...
const TERRITORY_CONFIG_DEFAULTS: Record<string, string> = {
  ...
  TERRITORY_GARRISON_CASH_COST: '350000',
  TERRITORY_GARRISON_HOURS: '8',
  TERRITORY_GARRISON_DEFENSE_BONUS_POINTS: '4',
  TERRITORY_GARRISON_CAPTURE_THRESHOLD_BONUS: '12',
  TERRITORY_GARRISON_MAX_ACTIVE_PER_CREW: '2',
  TERRITORY_GARRISON_MIN_HQ_LEVEL: '2',
