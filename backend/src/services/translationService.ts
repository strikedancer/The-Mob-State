  ...
  en: {
    email: {
      verification: {
        ...
        body: 'Please confirm this email address to finish creating your The Mob State account:',
  ...
  nl: {
    email: {
      verification: {
        ...
        greeting: (username) => `Hé ${username},`,
        body: 'Bevestig dit e-mailadres om je account bij The Mob State af te ronden:',
        buttonText: 'Bevestig e-mail',
