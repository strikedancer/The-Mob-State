...
const emailDE: Translations['email'] = {
  verification: {
    ...
    body: 'Bitte bestätige diese E-Mail-Adresse, um dein The Mob State-Konto fertigzustellen:',
...
const emailFR: Translations['email'] = {
  verification: {
    ...
    greeting: (username) => `Salut ${username},`,
    body: 'Confirme cette adresse e-mail pour terminer la création de ton compte The Mob State :',
...
const emailES: Translations['email'] = {
  verification: {
    ...
    body: 'Confirma esta dirección de correo para terminar de crear tu cuenta de The Mob State:',
...
const emailIT: Translations['email'] = {
  verification: {
    ...
    greeting: (username) => `Ciao ${username},`,
    body: 'Conferma questo indirizzo email per completare la creazione del tuo account The Mob State:',
...
const emailPL: Translations['email'] = {
  verification: {
    ...
    greeting: (username) => `Cześć ${username},`,
    body: 'Potwierdź ten adres e-mail, aby dokończyć tworzenie konta The Mob State:',
...
const emailPT: Translations['email'] = {
  verification: {
    ...
    greeting: (username) => `Olá ${username},`,
    body: 'Confirma este email para concluíres a criação da tua conta The Mob State:',
