...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    howNl: [
      ...
      'Player VIP geeft 10% kortere action timeouts (gevangenistijd blijft gelijk), wekelijkse 100 credits en een zachtere death-reset: je houdt bank/crypto/opleidingen/achievements, maar verliest wel assets, inventory en drugsvoorraad.',
    ...
    howEn: [
      ...
      'Player VIP gives 10% shorter action timeouts (jail time remains unchanged), 100 weekly credits, and a softer death reset: bank/crypto/education/achievements stay, while assets, inventory and drug stock are removed.',
