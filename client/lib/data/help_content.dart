...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    howNl: [
      ...
      'Bij arrestatie beland je in de gevangenis. Gevangenisstraf duurt maximaal(wanted level × 10) minuten, minimaal 5 minuten. Borg kost wanted level × €1.000. Gebruikte tools worden geconfisqueerd, gebruikte crime-wapens raak je kwijt en voertuigen kunnen ook in beslag worden genomen.',
    ...
    howEn: [
      ...
      'On arrest you go to prison. Sentence = max(wanted level × 10, 5) minutes. Bail = wanted level × €1.000. Required tools are confiscated, the used crime weapon is lost, and vehicles can also be seized.',
