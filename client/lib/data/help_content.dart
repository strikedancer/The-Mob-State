...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    howNl: [
      ...
      'Bij een succesvolle moord verliest het doelwit al het contante geld en alle gedragen items. Jij ontvangt naast de bounty een deel van die buit.',
    ...
    howEn: [
      ...
      'On a successful hit, the target loses all cash-on-hand and all carried items. You receive a share of that loot in addition to the bounty.',
