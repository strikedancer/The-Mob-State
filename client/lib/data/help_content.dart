...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    titleEn: 'Court',
    summaryNl:
        'Vecht je gevangenisstraf aan bij de rechtbank. Met de juiste advocaat of bewijs kun je je straftijd aanzienlijk verkorten.',
    summaryEn:
        'Contest your prison sentence in court. With the right lawyer or evidence you can significantly reduce your sentence.',
    howNl: [
      'Na arrestatie verschijn je in de rechtbank om je straf te bepalen. De basisstraf hangt af van je Wanted Level en de ernst van je laatste crime.',
      'Je kunt kiezen voor: Geen verdediging (automatisch vonnis), Eigen verdediging (gratis, lage kans op vermindering), Betaalde advocaat (hogere kosten, betere uitkomst).',
      'Advocaatkosten schalen mee met je Wanted Level: hoe hoger het Wanted Level, hoe duurder een effectieve advocaat.',
      'De rechtbank kijkt naar je criminal record: eerdere veroordelingen leiden tot zwaardere straffen. Een schone lei geeft meer kans op mildheid.',
      'Bij vrijspraak ga je direct vrij zonder straf. Dit is zeldzaam en alleen mogelijk als Wanted Level laag is en je een topadvocaat inhuurt.',
      'School-certifcering in rechten verlaagt advocaatkosten en verhoogt kans op gunstig vonnis.',
    ],
    howEn: [
      'After arrest you appear in court to have your sentence determined. The base sentence depends on your Wanted Level and the severity of your last crime.',
      'You can choose: No defense (automatic verdict), Self-defense (free, low reduction chance), Paid lawyer (higher cost, better outcome).',
      'Lawyer costs scale with your Wanted Level: the higher the Wanted Level the more expensive an effective lawyer.',
      'The court looks at your criminal record: previous convictions lead to heavier sentences. A clean record increases leniency.',
      'Acquittal releases you immediately without a sentence. This is rare and only possible at low Wanted Level with a top lawyer.',
      'School certification in law reduces lawyer costs and improves the chance of a favourable verdict.',
    ],
    tipsNl: [
      'Huur een advocaat in zodra je Wanted Level 3 of hoger is: de strafvermindering is de kosten altijd waard.',
      'Verlaag je Wanted Level actief voor grote crimerunss: lagere Wanted = lagere straf bij arrestatie.',
    ],
    tipsEn: [
      'Hire a lawyer as soon as Wanted Level is 3 or higher: the sentence reduction is always worth the cost.',
      'Actively lower your Wanted Level before big crime runs: lower Wanted = lighter sentence on arrest.',
    ],
