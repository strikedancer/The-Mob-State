...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    howNl: [
      ...
      'Bij een succesvolle moord krijgt het doelwit een harde reset van accountprogressie: bezittingen en voortgang worden teruggezet naar basisstatus. Jij ontvangt naast de bounty een deel van de beschikbare buit.',
    ...
    howEn: [
      ...
      'On a successful hit, the target receives a hard account-progress reset: assets and progression are reset to baseline status. You receive a share of available loot in addition to the bounty.',
