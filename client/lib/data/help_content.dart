...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    howNl: [
      ...
      'Op mobiel kun je nu pinchen, slepen en de zoomknoppen gebruiken om in te zoomen, zodat kleine gebieden makkelijker aantikbaar worden. Met de resetknop rechtsboven zet je de kaart weer snel terug.',
    ...
    howEn: [
      ...
      'On mobile you can now pinch, drag, and use the zoom buttons to zoom in, making smaller regions easier to tap. Use the reset button in the top-right corner to quickly restore the map.',
