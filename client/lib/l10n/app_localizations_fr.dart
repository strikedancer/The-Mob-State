...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get crewUiHintStorageTab =>
      'C’est le stock partagé de l’équipage : contrebande, missions, deals et raids. Pas un garage en plus — tu ne reprends pas voitures, bateaux ou armes pour tes propres crimes. Les drogues, si. Appuie sur le i doré pour l’explication complète.';
