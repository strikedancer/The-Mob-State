...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get hitDefendedBySecurity =>
      'L\'obiettivo difeso: gilet e guardie del corpo hanno ridotto le tue possibilità.';
  ...
  String get helpTopicHitlistTips =>
      'Controlla quotidianamente la lista dei risultati: taglie elevate sui giocatori deboli sono un rapido profitto se ti trovi nello stesso paese. \nMetti una taglia su un giocatore solo quando hai motivo di credere che sia offline o con pochi HP. \nSalta informazioni rapide a buon mercato se il bersaglio mantiene guardie del corpo d\'élite e ha giocato di recente; un rapporto Slow mostra sempre il paese. Attendi finché non rimangono offline per un lungo periodo o perdi il libro paga se desideri conteggi esatti.';
