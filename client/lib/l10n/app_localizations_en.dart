...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get helpTopicInventoryHow =>
      'Inventory opens as a paper-doll view: your avatar in the center, a crime-weapon slot, a second-weapon slot and a vest slot, plus square backpack slots.\nDrag an item (or tap it, then tap a valid target) to move it. On phones, tap-to-select is more reliable than dragging.\nIf a stack has more than one unit (ammo, materials, stacked weapons or tools), you choose how many to move: 1, all, or a custom amount.\nThe Inventory menu shows your paper-doll and backpack only. To stash or take goods, go to Properties and tap Open storage on that house, apartment or warehouse; that opens this screen with that building\'s grid. Stock in other countries stays there until you travel.\nHouses store weapons, ammo, vests, cash, materials, drugs and trade goods and are safer on arrest. A new house has 10 storage slots; upgrades raise that. Warehouses store tools plus the same stash types, but police search the warehouse in the country where you are arrested and seize about 40% of that stock. Bought or collected materials, drugs and trade goods go into your backpack and use backpack slots (trade 1 unit = 1 slot, drugs 50g/slot, materials 5/slot). Store them at a property before you travel, or customs and police can seize what you carry. Withdraw into your backpack again before you sell, smuggle or load a vehicle. Flying with goods in your backpack is self-smuggling. Cash uses buttons, not drag.\nYou can wear only one vest. Dropping a vest onto the avatar equips it; storing it in a house unequips it. A second worn vest is refused.\nYou can carry two weapons at once, for example a handgun and a rifle. When you commit a crime, the server looks at both worn slots and automatically uses the best match for that crime.\nOnly usable weapons worn on slot 1 or 2 count for crimes.\nBackpack capacity covers tools, unequipped weapons, carried materials, drugs and trade goods. Worn weapons, ammo and the worn vest do not use backpack slots. Upgrade bags on the Black Market: small → medium → large → military → VIP tactical (VIP) → travel suitcase (VIP, +70 slots, rank 30, 75 total). The server rejects full packs, wrong country and wrong property type.\nLoadouts remain a second tab for saved crime or travel sets.\nDrugs are stored and shown as grams; 351 means 351g. Crew storage stays a separate safe stash.\nOn arrest police can confiscate items. Drugs in inventory increase FBI risk on international travel.';
