...
abstract class AppLocalizations {
  ...
  /// Tooltip for the top-bar avatar button that opens my profile, messages, help, settings, and logout.
  ///
  /// In en, this message translates to:
  /// **'Account menu'**
  ...
  /// No description provided for @seasonPassGoalProstitution.
  ///
  /// In en, this message translates to:
  /// **'Recruit {count} workers'**
  ...
  /// No description provided for @stabVest.
  ///
  /// In en, this message translates to:
  /// **'Stab vest'**
  String get stabVest;

  /// No description provided for @stabVestDesc.
  ///
  /// In en, this message translates to:
  /// **'Stops knives and stab weapons. Weak against bullets.'**
  String get stabVestDesc;

  /// No description provided for @bulletproofVestDesc.
  ///
  /// In en, this message translates to:
  /// **'Standard ballistic protection against regular ammo.'**
  String get bulletproofVestDesc;

  /// No description provided for @bulletproofVestPremium.
  ///
  /// In en, this message translates to:
  /// **'Premium bulletproof vest'**
  String get bulletproofVestPremium;

  /// No description provided for @bulletproofVestPremiumDesc.
  ///
  /// In en, this message translates to:
  /// **'Heavier plates and more coverage against regular rounds.'**
  String get bulletproofVestPremiumDesc;

  /// No description provided for @ceramicApVest.
  ///
  /// In en, this message translates to:
  /// **'AP plate vest'**
  String get ceramicApVest;

  /// No description provided for @ceramicApVestDesc.
  ///
  /// In en, this message translates to:
  /// **'Ceramic plates that stop armor-piercing rounds.'**
  String get ceramicApVestDesc;

  /// No description provided for @vestProtectsStab.
  ///
  /// In en, this message translates to:
  /// **'Stab'**
  String get vestProtectsStab;

  /// No description provided for @vestProtectsBullets.
  ///
  /// In en, this message translates to:
  /// **'Bullets'**
  String get vestProtectsBullets;

  /// No description provided for @vestProtectsAp.
  ///
  /// In en, this message translates to:
  /// **'Armor-piercing'**
  String get vestProtectsAp;
  ...
  /// No description provided for @hitDefendedBySecurity.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @hitDefendedAttrition.
  ///
  /// In en, this message translates to:
  /// **'{guards} bodyguards down, target -{health} HP. Next attempt in 10 minutes.'**
  String hitDefendedAttrition(String guards, String health);

  /// No description provided for @hitCombatAttackerAttrition.
  ///
  /// In en, this message translates to:
  /// **'You lost {guards} bodyguards and {health} HP.'**
  String hitCombatAttackerAttrition(String guards, String health);

  /// No description provided for @hitlistErrCombatCooldown.
  ///
  /// In en, this message translates to:
  /// **'The target is still under fire. Try again in {minutes} minutes.'**
  String hitlistErrCombatCooldown(String minutes);

  /// No description provided for @hitCombatBreakdown.
  ///
  /// In en, this message translates to:
  /// **'Vest +{armor} · bodyguards +{guards} · your chance {chance}%'**
  ...
  /// No description provided for @crimeTrainingComboStrip.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @territoryNoticeEncircled.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @territoryGarrisonTitle.
  ///
  /// In en, this message translates to:
  /// **'Garrison / air defense'**
  String get territoryGarrisonTitle;

  /// No description provided for @territoryGarrisonDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @territoryGarrisonDeploy.
  ///
  /// In en, this message translates to:
  /// **'Deploy garrison'**
  String get territoryGarrisonDeploy;

  /// No description provided for @territoryGarrisonActiveUntil.
  ///
  /// In en, this message translates to:
  /// **'Garrison active until {time}'**
  String territoryGarrisonActiveUntil(String time);

  /// No description provided for @territoryGarrisonCostHours.
  ///
  /// In en, this message translates to:
  /// **'{cost} from the crew bank · {hours}h'**
  String territoryGarrisonCostHours(String cost, int hours);

  /// No description provided for @territoryGarrisonDialogTitle.
  ///
  /// In en, this message translates to:
  /// **'Deploy garrison?'**
  String get territoryGarrisonDialogTitle;

  /// No description provided for @territoryGarrisonDialogBody.
  ///
  /// In en, this message translates to:
  /// **'Pay {cost} from the crew bank to station tanks and air defense here for {hours} hours. The region can still be attacked, but it is harder to take.'**
  String territoryGarrisonDialogBody(String cost, int hours);

  /// No description provided for @territorySnackGarrisonDeployed.
  ///
  /// In en, this message translates to:
  /// **'Garrison deployed.'**
  ...
  /// No description provided for @launderSectionTitle.
  ///
  /// In en, this message translates to:
  /// **'Money laundering'**
  String get launderSectionTitle;

  /// No description provided for @launderSectionHint.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Estimated seize chance: {chance}%'**
  String launderSeizeChance(String chance);

  /// No description provided for @launderActiveJob.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Start wash'**
  String get launderStartButton;

  /// No description provided for @launderStartedSuccess.
  ///
  /// In en, this message translates to:
  /// **'Laundering started.'**
  String get launderStartedSuccess;

  /// No description provided for @launderErrorCooldown.
  ///
  /// In en, this message translates to:
  /// **'Laundering is on cooldown.'**
  String get launderErrorCooldown;

  /// No description provided for @launderErrorActive.
  ///
  /// In en, this message translates to:
  /// **'A wash job is already running.'**
  ...
  /// No description provided for @launderErrorDisabled.
  ///
  /// In en, this message translates to:
  /// **'Money laundering is disabled.'**
  String get launderErrorDisabled;

  /// No description provided for @launderErrorUnknown.
  ///
  /// In en, this message translates to:
  /// **'Could not start laundering.'**
  ...
  /// No description provided for @stockMarketHint.
  ///
  /// In en, this message translates to:
  /// **'Trade with bank money. Prices move slowly — separate from crypto.'**
  String get stockMarketHint;

  /// No description provided for @stockBankBalance.
  ///
  /// In en, this message translates to:
  /// **'Bank balance'**
  String get stockBankBalance;

  /// No description provided for @stockPortfolioValue.
  ///
  /// In en, this message translates to:
  /// **'Portfolio value'**
  String get stockPortfolioValue;
  ...
  /// No description provided for @stockHolding.
  ///
  /// In en, this message translates to:
  /// **'Holding'**
  String get stockHolding;
  ...
  /// No description provided for @stockBuy.
  ///
  /// In en, this message translates to:
  /// **'Buy'**
  String get stockBuy;

  /// No description provided for @stockSell.
  ///
  /// In en, this message translates to:
  /// **'Sell'**
  String get stockSell;

  /// No description provided for @stockTradeSuccess.
  ///
  /// In en, this message translates to:
  /// **'Trade completed.'**
  String get stockTradeSuccess;

  /// No description provided for @stockErrorInsufficientBalance.
  ///
  /// In en, this message translates to:
  /// **'Not enough bank balance.'**
  String get stockErrorInsufficientBalance;

  /// No description provided for @stockErrorInsufficientShares.
  ///
  /// In en, this message translates to:
  /// **'Not enough shares.'**
  String get stockErrorInsufficientShares;

  /// No description provided for @stockErrorPositionLimit.
  ///
  /// In en, this message translates to:
  /// **'Position limit reached.'**
  String get stockErrorPositionLimit;

  /// No description provided for @stockErrorDisabled.
  ///
  /// In en, this message translates to:
  /// **'Stock market is disabled.'**
  String get stockErrorDisabled;

  /// No description provided for @stockErrorUnknown.
  ///
  /// In en, this message translates to:
  /// **'Trade failed.'**
  ...
  /// In en, this message translates to:
  /// **'Develop'**
  String get propertyDevelopAction;

  /// No description provided for @propertyDevelopedSuccess.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Economy'**
  String get helpTopicStockMarketCategory;

  /// No description provided for @helpTopicStockMarketTitle.
  ///
  /// In en, this message translates to:
  /// **'Stock market'**
  String get helpTopicStockMarketTitle;

  /// No description provided for @helpTopicStockMarketSummary.
  ///
  /// In en, this message translates to:
  /// **'Trade slow-moving stocks with bank money. Separate system from crypto.'**
  String get helpTopicStockMarketSummary;

  /// No description provided for @helpTopicStockMarketHow.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @helpTopicStockMarketTips.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @territoryBonusGarrison.
  ///
  /// In en, this message translates to:
  /// **'Garrison / air defense'**
  String get territoryBonusGarrison;
