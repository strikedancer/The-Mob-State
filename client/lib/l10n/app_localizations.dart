...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Check the hitlist daily: high bounties on weak players are quick profit if you are in the same country.\nOnly place a bounty on a player when you have reason to believe they are offline or low on HP.\nSkip cheap Quick intel if the target keeps elite bodyguards and has been playing recently; a Slow report always shows the country. Wait until they stay offline for long or miss payroll if you want exact counts.'**
