...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Each country has one or more Red Light Districts that can be claimed. Claim a district by paying a set purchase amount.\nAs owner of a district you receive a percentage of all prostitution income in that country — including from other players operating there.\nThere is no player-vs-player district takeover. Police raids can still hit your workers when FBI heat is high; higher security lowers raid chance.\nIn district detail you can upgrade tier (earnings) and security (raid risk), and view live raid stats (FBI heat, raid chance).\nYou can own up to 3 districts simultaneously. Strategic country choice is essential.\nBusiest countries (Colombia, Dubai, Japan) give the highest passive income.\nSelling or losing a district does not refund the purchase price.'**
