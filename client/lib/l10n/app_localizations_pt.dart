...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get crewUiHintStorageTab =>
      'Este é o estoque compartilhado da Crew: contrabando, missões, negócios e ataques. Não é uma garagem extra – você não pode devolver carros, barcos ou armas pelos seus próprios crimes. As drogas podem ser retiradas. Toque no i dourado para obter a explicação completa.';
