...
class AppLocalizationsNl extends AppLocalizations {
  ...
  String get helpTopicInventoryHow =>
      'Inventaris opent als paper-doll: jouw avatar in het midden, een crime-wapenslot, een tweede wapenslot en een vestslot, plus vierkante rugzakvakjes.\nSleep een item (of tik het aan en tik daarna op een geldig doel) om het te verplaatsen. Op de telefoon is tikken betrouwbaarder dan slepen.\nBij een stapel van meer dan één (munitie, materialen, gestapelde wapens of tools) kies je hoeveel je verplaatst: 1, alles, of een eigen aantal.\nHet Inventaris-menu toont alleen je paper-doll en rugzak. Om te stallen of eruit te halen ga je naar Eigendommen en tik je Open opslag op dat huis, appartement of magazijn; dat opent dit scherm met het grid van dat pand. Voorraad in andere landen blijft daar tot je erheen reist.\nHuizen bewaren wapens, munitie, vesten, cash, materialen, drugs en handelswaren en zijn veiliger bij aanhouding. Een nieuw huis heeft 10 opslagvakjes; upgraden vergroot dat. Magazijnen bewaren gereedschap plus dezelfde stash-types, maar de politie doorzoekt het magazijn in het land waar je wordt opgepakt en neemt ongeveer 40% van die voorraad in beslag. Gekochte of opgehaalde materialen, drugs en handelswaren gaan in je rugzak en gebruiken rugzakvakjes (handel 1 stuk = 1 vak, drugs 50g/vak, materialen 5/vak). Zet ze in een pand vóór je reist, anders kan douane of politie meegenomen waar afpakken. Haal ze weer in je rugzak vóór je verkoopt, smokkelt of een voertuig laadt. Vliegen met spullen in je tas is zelf smokkelen. Cash gebruikt knoppen, geen slepen.\nJe draagt maar één vest. Een vest op de avatar droppen trekt het aan; opslaan in een huis trekt het uit. Een tweede gedragen vest wordt geweigerd.\nJe kunt twee wapens tegelijk dragen, bijvoorbeeld een handgun en een automatisch geweer. Bij een crime kijkt de server naar beide gedragen slots en gebruikt automatisch het beste wapen voor die crime.\nAlleen gedragen, bruikbare wapens op slot 1 of 2 tellen mee voor crimes.\nRugzakcapaciteit telt tools, niet-gedragen wapens, meegenomen materialen, drugs en handelswaren. Gedragen wapens, munitie en het vest gebruiken geen rugzakvakjes. Upgrade via de Zwarte Markt: klein → middel → groot → militair → VIP tactisch (VIP) → reiskoffer (VIP, +70 vakken, rang 30, 75 totaal). De server weigert een volle tas, een verkeerd land en een verkeerd pandtype.\nLoadouts blijven een tweede tab voor bewaarde crime- of reissets.\nDrugs worden als gram getoond; 351 betekent 351g. Crew-opslag blijft een aparte veilige stash.\nBij arrestatie kan de politie items confisqueren. Drugs in je inventaris verhogen het FBI-risico bij internationaal reizen.';
