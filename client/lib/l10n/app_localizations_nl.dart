...
class AppLocalizationsNl extends AppLocalizations {
  ...
  String get hitDefendedBySecurity =>
      'Het doelwit verdedigde zich — vest en lijfwachten verlaagden je kans.';
  ...
  String get helpTopicHitlistTips =>
      'Check de hitlist dagelijks: hoge bounties op zwakke spelers zijn snelle winst als je in hetzelfde land zit.\nLeg een bounty alleen op een speler als je aanwijzingen hebt dat ze offline zijn of laag in HP.\nSla goedkoop Snel-onderzoek over als het doelwit elite-lijfwachten houdt en recent speelt; Langzaam toont altijd het land. Wacht tot ze lang offline zijn of het dagloon missen als je exacte aantallen wilt.';
