...
class _AchievementsScreenState extends State<AchievementsScreen>
  ...
  String _localizedAchievementTitle(Achievement achievement) {
    return localizedAchievementTitle(
  ...
  String _localizedCategoryLabel(String category) {
    return localizedAchievementCategory(AppLocalizations.of(context)!, category);
  }
  ...
  String _getBadgeAssetPath(Achievement achievement) {
    return achievementBadgeAssetPath(achievement.category, achievement.id);
  }

  String _getLegacyBadgeAssetPath(Achievement achievement) {
    return achievementLegacyBadgeAssetPath(achievement.id);
  }
